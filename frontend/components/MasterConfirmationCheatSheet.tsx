...
const SECTIONS = [
  ...
  {
    num: '03', name: 'Pivot Section',
    param: 'Break + Conf > 60%',
    buy: 'Price > Pivot & conf >60%',
    sell: 'Price < Pivot & conf >60%',
    skip: 'Conf < 55% → Ignore',
  },
  {
    num: '04', name: 'Open Breakout',
  ...
  {
    num: '07', name: 'RSI 60–40',
    param: '60/40 Zone Break',
    buy: 'RSI > 60 & holding',
    sell: 'RSI < 40 & holding',
    skip: 'RSI 40–60 → No momentum',
  },
  {
    num: '08', name: 'Camera Law',
  ...
  {
    num: '10', name: '20 Entry Filter',
    param: 'Align with Trend',
    buy: 'Trigger in trend dir',
    sell: 'Counter-trend → Ignore',
    skip: 'Counter-trend',
  },
  {
    num: '11', name: 'High Vol Candle Scanner',
    param: 'Volume Spike Direction',
    buy: 'High vol bullish candle',
    sell: 'High vol bearish candle',
    skip: '–',
  },
  {
    num: '12', name: 'Smart Money Flow',
    param: 'Net Inst. Flow',
  ...
  {
    num: '14', name: 'OI Momentum Signals',
