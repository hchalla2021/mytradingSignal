...
const ExpiryCard = memo<{ data: ExpiryIndex | null; name: string }>(({ data, name }) => {
  ...
  return (
    <div className={`rounded-2xl border ${cardBorder} bg-gradient-to-br from-slate-800/70 via-slate-900/70 to-slate-800/50 backdrop-blur-sm p-3 sm:p-4`}>
      ...
      {ai && (
        <div className="mb-3 rounded-2xl border border-cyan-500/25 bg-gradient-to-br from-cyan-500/10 to-slate-900/40 p-3 shadow-inner shadow-cyan-500/10">
          ...
          <div className="grid grid-cols-1 gap-2 lg:grid-cols-2">
            <div className="rounded-lg border border-slate-700/60 bg-slate-950/55 p-2">
            ...
            <div className="rounded-lg border border-slate-700/60 bg-slate-950/55 p-2">
              ...
              <div className="mt-2 rounded-md bg-slate-900/80 px-2 py-1 text-[9px] text-slate-400">
                {ai.summary.phase}: {ai.summary.direction} {ai.summary.action}
              </div>
            </div>
          </div>
          ...
          {ai.commandDeck.alerts.length > 0 && (
            <div className="mt-3 rounded-lg border border-cyan-500/20 bg-cyan-500/5 p-2">
              <div className="mb-1 text-[10px] font-bold uppercase tracking-wide text-cyan-300">Command Alerts</div>
