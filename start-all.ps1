...
if ($port8001) {
    ...
    Write-Host "  [OK] Stopped process on port 8001" -ForegroundColor Green
}
...
if (-not $backendReady) {
    Write-Host "[WARNING] Backend may still be starting. Check the backend window for errors." -ForegroundColor Yellow
}
...
Write-Host "  [READY] ALL SYSTEMS READY!" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
